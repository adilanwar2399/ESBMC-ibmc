        ...
        if name_of_the_c_benchmark_file.endswith('.c'):
            ...
            while True:
                ...
                for insertion_index, line in enumerate(new_code):
                    if 'while' in line:
                        new_code.insert(insertion_index, invariant_candidates_bb)
                        break
                ...
                if run_esbmc_with_script.returncode !=0: 
                    ...
                    while True:
                        ...
                        if invariant_generation_iteration <6:
                            ...
                            "
                            Based on these examples provided above, alongside these invariant candidates generated from the blackbox
                            ...
                            Can you generate a C invariant for the following code,
                            “
                            \n"""+c_code+"""\n
                            ...
                            Generate a Single Valid Invariant for the Loop: Provide one single valid invariant for the loop in the program. 
                            The invariants should assist in proving the assertions within the program.
                            ...
                            Key Requirements:
                                The loop must have its own uniquely labeled comment (// Line A).
                                Only output the invariants in the specified format.
                                No explanation is needed or required for the generated invariants.

                            Ensure the response adheres strictly to the outlined format and contains no additional information beyond the required invariant.
                            """
                            ...
                            Can you generate C invariants for the following code,
                            “
                            \n"""+c_code+"""\n
                            ...
                            Generate Two Valid Invariants for the Loop: Provide two valid invariants for the loop in the program. Each invariant can use a valid combination of logical operators if necessary. These invariants should assist in proving the assertions within the program.
                            ...
                            Generate Three Valid Invariants for Each Loop: Provide two valid invariants for the loop in the program. Each invariant can use a valid combination of logical operators if necessary. These invariants should assist in proving the assertions within the program.
                            ...
                            Ensure the response adheres strictly to the outlined format and contains no additional information beyond the required invariants.
                            """
                        if invariant_generation_iteration == 61:

                            break;

                        result = subprocess.run(
                            ["ollama", "run", "llama3.2:latest", code_modifying_prompt],
                            capture_output=True,
                            text=True
                        )

                        generated_modified_code = result.stdout.strip()
