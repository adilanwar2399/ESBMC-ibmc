...
As an alternative to building from source, you can [download Vampire 4.7](https://github.com/vprover/vampire/releases/tag/v4.7). We have not tested with Vampire 4.7, but expect it to work. Please note that the binary included in the Vampire releases will only run on Linux distros, no macOS.
